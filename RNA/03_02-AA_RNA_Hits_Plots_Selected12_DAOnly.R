...
dat <- read.table("/Users/Rui/Rui Folders/Royal-Rock/Work/Snyder Lab Work Selected/Results/AA/AA_Methyl_Seq/Analyses/20141208-From_George/20150317-RNA_Seq_EpigenomicMarks/AA_RNA_Hits_Reordered_QN_Selected12_DA.txt", sep = "\t", header = TRUE)
# Column Names.
