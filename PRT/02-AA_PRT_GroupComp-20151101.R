...
############################################################
# Load data.
dat <- read.table("/Users/Rui/Rui Folders/Royal-Rock/Work/Snyder Lab Work Selected/Results/AA/AA_Proteomics_20150729/Results/20151029_Pass01/AA_PRT_Combined_Results_ANNO_NA_20151101_NoMiss.txt",  header =TRUE, sep = "\t")
